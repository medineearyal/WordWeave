...
<footer class="footer">
	<div class="footer-content section-container">
		<div>
			<div class="left">
				...
				<div class="text">
					<p>
						Welcome to WordWeave,where your<br> writing meets a platform.
						<br> We are focused on providing you the <br>best of the
						experience
					</p>
	...
	<div>
		...
		<p class="copyright"
			...
			Copyright &copy; <span class="copyright-date"></span> WordWeave
		</p>
	</div>
</footer>
<script
